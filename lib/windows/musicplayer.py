...
class MusicPlayerWindow(currentplaylist.CurrentPlaylistWindow):
    ...
    def onFirstInit(self):
        ...
        player.PLAYER.on('starting.audio', self.testEvent1)
        player.PLAYER.on('started.audio', self.testEvent2)
    ...
    def doClose(self, **kwargs):
        ...
        player.PLAYER.off('starting.audio', self.testEvent1)
        player.PLAYER.off('started.audio', self.testEvent2)
        kodigui.ControlledWindow.doClose(self)

    def testEvent1(self, *args, **kwargs):
        util.setGlobalProperty('ignore_spinner', '1')
        self.ignoreStopCommands = True

    def testEvent2(self, *args, **kwargs):
